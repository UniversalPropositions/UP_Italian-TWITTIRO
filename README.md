...
- `git clone https://github.com/UniversalPropositions/UP_Italian-TWITTIRO.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Italian-TWITTIRO>/ --input_up=<up_path_to_UP_Italian-TWITTIRO>/ --output=<path_to_UD+UP_Italian-TWITTIRO>/`
